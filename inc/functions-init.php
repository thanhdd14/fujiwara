...
if (! function_exists('oc_enqueue')) {
    function oc_enqueue()
    {
        ...
        if ($is_production) {
            ...
            wp_enqueue_style('oc-slick', ($uri . '/css/slick.css'), array('boostrap-css'), $asset_version, 'all');
            wp_enqueue_style('oc-slick-theme', ($uri . '/css/slick-theme.css'), array('boostrap-css'), $asset_version, 'all');
        ...
        if ($is_production) {
            ...
            wp_enqueue_script('oc-jquery', ($uri . '/js/jquery-3.3.1.min.js'), array('jquery', 'boostrap-js'), $asset_version, true);
            wp_enqueue_script('boostrap-js', ($uri . '/js/bootstrap.min.js'), array('jquery'), $asset_version, true);
            wp_enqueue_script('oc-slick-js', ($uri . '/js/slick.min.js'), array('jquery', 'boostrap-js'), $asset_version, true);
            wp_enqueue_script('oc-match-js', ($uri . '/js/jquery.matchHeight-min.js'), array('jquery', 'boostrap-js'), $asset_version, true);
